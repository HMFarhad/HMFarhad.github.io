// Reference template for src/environments/environment.ts and environment.prod.ts.
// The actual files are generated at build time by scripts/inject-env.mjs from
// these env vars (set locally in your shell, or as GitHub Actions repo secrets):
//   EMAILJS_PUBLIC_KEY
//   EMAILJS_SERVICE_ID
